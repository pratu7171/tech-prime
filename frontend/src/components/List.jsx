...
const List = () => {
  ...
  return (
    <div className="w-full md:w-[1276px] md:h-[555px] mx-auto rounded-[10px] md:pt-0 pt-[50px] mr-[16px]">
      <div
        className="pt-[20px] md:pt-[10px] flex flex-col md:bg-white bg-[#F3F5F7] rounded-[10px]"
        style={{
          boxShadow:
            window.innerWidth >= 1024
              ? "0 7px 18px 0 rgba(2, 118, 179, 0.13)"
              : "none",
        }}
      >
                  ...
                  <tr key={item._id} className="border-b border-[#E0E0E0]">
                    <td className="p-2 text-center">
                      <div className="flex flex-col">
                        <span className="text-left pl-[14px] text-[16px] leading-[22px] text-[#414950] font-nunito font-[800] tracking-wider">
                          {item.ProjectName}
                        </span>
                    ...
                    <td className="pl-[20px] text-left text-[14px] leading-[19px] font-nunito text-[#3f3f3f]">
                      {item.Reason}
                    </td>
                    <td className="pl-[20px] text-left text-[14px] leading-[19px] font-nunito text-[#3f3f3f]">
                      {item.Type}
                    ...
                    <td className="pl-[20px] text-left text-[14px] leading-[19px] font-nunito text-[#3f3f3f] font-[800]">
                      {item.Status}
                    </td>
                    <td className="p-2 text-center">
                      <button
          ...
          <div className="grid grid-cols-1 gap-4">
            {data.length > 0 &&
              data.map((item) => (
                <div
                  key={item._id}
                  className="pt-[20px] pl-[17px] pr-[15px] pb-[16px] bg-white rounded-[10px] w-[328px] h-[257px] ml-3"
                >
                  <div className="flex justify-between mb-[16px]">
                    <div className="flex flex-col">
                      <span className="leading-[22px] text-[16px] font-nunito text-[#414950] tracking-wider font-[800]">
                        {item.ProjectName}
                      </span>
                      <span className="text-[14px] leading-[19px] text-[#6B6B6B] font-nunito">
                        {" "}
                        ({moment(item.StartDate).format("MMM-DD, YYYY")} to{" "}
                        {moment(item.EndDate).format("MMM-DD, YYYY")})
                      </span>
                    ...
                    <div>
                      <span className="text-[14px] leading-[19px] text-[#00284C] font-nunito font-[600]">
                        {item.Status}
                      </span>
                    </div>
                  </div>
                  <div className="flex justify-between">
                    <div className="text-[14px] leading-[19px] text-[#898989] font-nunito">
                      Reason:
                      <span className="text-[14px] leading-[19px] text-[#3F3F3F] font-nunito ml-[2px]">
                        {item.Reason}
                      </span>
                    </div>
                  </div>
                  <div className="mt-[5px] flex">
                    ...
                    <div className="text-[14px] leading-[19px] text-[#898989] font-nunito ml-[6px]">
                      Category:
                      <span className="text-[14px] leading-[19px] text-[#3F3F3F] font-nunito ml-[2px]">
                        {item.Category}
                      </span>
